      ...
      <div class="cart-product clearfix">
        <table>
          ...
          <tr v-for="(item,index) in productList ">
            <td class="td-check"><span class="check-span" v-bind:class="{'check-true': item.checked}" @click="selectItem(item)"></span></td>
            ...
            <td class="td-num">
              <div class="product-num">
                <a href="javascript:;" class="num-reduce num-do fl" @click="handelJ(item,-1)"><span></span></a>
                <input type="text" class="num-input" value="0" v-model="item.pro_num">
                <a href="javascript:;" class="num-add num-do fr" @click="handelJ(item,1)"><span></span></a>
              </div>
            </td>
            <td class="td-price">
              <p class="red-text"><span class="price-text">{{ item.pro_price | formatValue }}</span></p>
            </td>
            <td class="td-total">
...
<style>
  ...
  .page-shopping-cart .check-span {
    ...
    width: 24px;
    height: 20px;
    background: url("assets/cartAll.png") no-repeat 0 0; }
  .page-shopping-cart .check-span.check-true {
    background: url("assets/cartAll.png") no-repeat 0 -22px; }
  ...
  .page-shopping-cart .cart-product table .product-num .num-reduce span {
    background: url("assets/cartAll.png") no-repeat -40px -22px;
    display: block;
    width: 6px;
    height: 2px;
    margin: 13px auto 0 auto; }
  .page-shopping-cart .cart-product table .product-num .num-add span {
    background: url("assets/cartAll.png") no-repeat -60px -22px;
    display: block;
    width: 8px;
    height: 8px;
  ...
  .page-shopping-cart .cart-product-info .delect-product span {
    ...
    width: 13px;
    height: 15px;
    background: url("assets/cartAll.png") no-repeat -60px 0; }
  ...
  .page-shopping-cart .cart-product-info .keep-shopping span {
    ...
    width: 15px;
    height: 15px;
    background: url("assets/cartAll.png") no-repeat -40px 0; }
  ...
  .page-shopping-cart .cart-worder .choose-worder span {
    ...
    width: 22px;
    height: 22px;
    background: url("assets/cartAll.png") no-repeat -92px 0; }
  ...
  .choose-worker-box .box-title a {
    ...
    width: 10px;
    height: 10px;
    background: url("assets/cartAll.png") no-repeat -80px 0; }
  .choose-worker-box .box-title a:hover {
    background: url("assets/cartAll.png") no-repeat -80px -22px; }
